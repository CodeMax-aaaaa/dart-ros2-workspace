...
typedef struct
{
	...
	lv_obj_t *Main_spinbox_distance_Y;
	lv_obj_t *Main_spinbox_distance_Y_btn;
	lv_obj_t *Main_spinbox_distance_Y_btn_minus;
	...
	lv_obj_t *Main_list_darts_item0;
	lv_obj_t *Main_list_darts_item1;
	lv_obj_t *Main_list_darts_item2;
	lv_obj_t *Main_list_darts_item3;
	lv_obj_t *Main_list_darts_item4;
	lv_obj_t *Main_list_darts_item5;
	lv_obj_t *Main_list_darts_item6;
	lv_obj_t *Main_list_darts_item7;
	lv_obj_t *Main_list_darts_item8;
	lv_obj_t *Main_list_darts_item9;
	lv_obj_t *Main_list_darts_item10;
	lv_obj_t *Main_label_35;
	lv_obj_t *Main_btn_add_dart;
	lv_obj_t *Main_btn_add_dart_label;
	lv_obj_t *Main_cont_dart_param;
	lv_obj_t *Main_label_36;
	lv_obj_t *Main_ta_dart_param_number;
	lv_obj_t *Main_label_38;
	lv_obj_t *Main_spinbox_dart_param_fw_offset;
	lv_obj_t *Main_spinbox_dart_param_fw_offset_btn;
	lv_obj_t *Main_spinbox_dart_param_fw_offset_btn_minus;
	...
	lv_obj_t *Main_btn_delete_dart;
	lv_obj_t *Main_btn_delete_dart_label;
	lv_obj_t *Main_msgbox_delete_confirm;
