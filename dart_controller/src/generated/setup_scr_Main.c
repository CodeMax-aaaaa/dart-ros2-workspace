...
void setup_scr_Main(lv_ui *ui)
{
	...
	lv_label_set_text(ui->Main_label_27, "目标直线距离Dis");
	...
	//Write codes Main_spinbox_target_delta_height
	ui->Main_spinbox_target_delta_height = lv_spinbox_create(ui->Main_MainView_tab_1);
	lv_obj_set_pos(ui->Main_spinbox_target_delta_height, 666, 398);
	lv_obj_set_width(ui->Main_spinbox_target_delta_height, 180);
	lv_obj_set_height(ui->Main_spinbox_target_delta_height, 55);
	lv_spinbox_set_digit_format(ui->Main_spinbox_target_delta_height, 6, 4);
	lv_spinbox_set_range(ui->Main_spinbox_target_delta_height, -999999, 999999);
	lv_coord_t Main_spinbox_target_delta_height_h = lv_obj_get_height(ui->Main_spinbox_target_delta_height);
	ui->Main_spinbox_target_delta_height_btn = lv_btn_create(ui->Main_MainView_tab_1);
	lv_obj_set_size(ui->Main_spinbox_target_delta_height_btn, Main_spinbox_target_delta_height_h, Main_spinbox_target_delta_height_h);
	lv_obj_align_to(ui->Main_spinbox_target_delta_height_btn, ui->Main_spinbox_target_delta_height, LV_ALIGN_OUT_RIGHT_MID, 5, 0);
	lv_obj_set_style_bg_img_src(ui->Main_spinbox_target_delta_height_btn, LV_SYMBOL_PLUS, 0);
	lv_obj_add_event_cb(ui->Main_spinbox_target_delta_height_btn, lv_Main_spinbox_target_delta_height_increment_event_cb, LV_EVENT_ALL, NULL);
	ui->Main_spinbox_target_delta_height_btn_minus = lv_btn_create(ui->Main_MainView_tab_1);
	lv_obj_set_size(ui->Main_spinbox_target_delta_height_btn_minus, Main_spinbox_target_delta_height_h, Main_spinbox_target_delta_height_h);
	lv_obj_align_to(ui->Main_spinbox_target_delta_height_btn_minus, ui->Main_spinbox_target_delta_height, LV_ALIGN_OUT_LEFT_MID, -5, 0);
	lv_obj_set_style_bg_img_src(ui->Main_spinbox_target_delta_height_btn_minus, LV_SYMBOL_MINUS, 0);
	lv_obj_add_event_cb(ui->Main_spinbox_target_delta_height_btn_minus, lv_Main_spinbox_target_delta_height_decrement_event_cb, LV_EVENT_ALL, NULL);
	lv_obj_set_pos(ui->Main_spinbox_target_delta_height, 666, 398);

	//Write style for Main_spinbox_target_delta_height, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_bg_opa(ui->Main_spinbox_target_delta_height, 238, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->Main_spinbox_target_delta_height, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_dir(ui->Main_spinbox_target_delta_height, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_width(ui->Main_spinbox_target_delta_height, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_opa(ui->Main_spinbox_target_delta_height, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_color(ui->Main_spinbox_target_delta_height, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_side(ui->Main_spinbox_target_delta_height, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_top(ui->Main_spinbox_target_delta_height, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_right(ui->Main_spinbox_target_delta_height, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_bottom(ui->Main_spinbox_target_delta_height, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_left(ui->Main_spinbox_target_delta_height, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_color(ui->Main_spinbox_target_delta_height, lv_color_hex(0x2c2c2c), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->Main_spinbox_target_delta_height, &lv_font_misans_35, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_opa(ui->Main_spinbox_target_delta_height, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_letter_space(ui->Main_spinbox_target_delta_height, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->Main_spinbox_target_delta_height, 7, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_width(ui->Main_spinbox_target_delta_height, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

	//Write style for Main_spinbox_target_delta_height, Part: LV_PART_CURSOR, State: LV_STATE_DEFAULT.
	lv_obj_set_style_text_color(ui->Main_spinbox_target_delta_height, lv_color_hex(0xcbeaed), LV_PART_CURSOR|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->Main_spinbox_target_delta_height, &lv_font_misans_35, LV_PART_CURSOR|LV_STATE_DEFAULT);
	lv_obj_set_style_text_opa(ui->Main_spinbox_target_delta_height, 255, LV_PART_CURSOR|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_opa(ui->Main_spinbox_target_delta_height, 255, LV_PART_CURSOR|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->Main_spinbox_target_delta_height, lv_color_hex(0x098D6B), LV_PART_CURSOR|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_dir(ui->Main_spinbox_target_delta_height, LV_GRAD_DIR_NONE, LV_PART_CURSOR|LV_STATE_DEFAULT);

	//Write style state: LV_STATE_DEFAULT for &style_Main_spinbox_target_delta_height_extra_btns_main_default
	static lv_style_t style_Main_spinbox_target_delta_height_extra_btns_main_default;
	ui_init_style(&style_Main_spinbox_target_delta_height_extra_btns_main_default);
	
	lv_style_set_text_color(&style_Main_spinbox_target_delta_height_extra_btns_main_default, lv_color_hex(0xffffff));
	lv_style_set_text_font(&style_Main_spinbox_target_delta_height_extra_btns_main_default, &lv_font_misans_12);
	lv_style_set_text_opa(&style_Main_spinbox_target_delta_height_extra_btns_main_default, 255);
	lv_style_set_bg_opa(&style_Main_spinbox_target_delta_height_extra_btns_main_default, 183);
	lv_style_set_bg_color(&style_Main_spinbox_target_delta_height_extra_btns_main_default, lv_color_hex(0x00a1b5));
	lv_style_set_bg_grad_dir(&style_Main_spinbox_target_delta_height_extra_btns_main_default, LV_GRAD_DIR_NONE);
	lv_style_set_border_width(&style_Main_spinbox_target_delta_height_extra_btns_main_default, 0);
	lv_style_set_radius(&style_Main_spinbox_target_delta_height_extra_btns_main_default, 10);
	lv_obj_add_style(ui->Main_spinbox_target_delta_height_btn, &style_Main_spinbox_target_delta_height_extra_btns_main_default, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_add_style(ui->Main_spinbox_target_delta_height_btn_minus, &style_Main_spinbox_target_delta_height_extra_btns_main_default, LV_PART_MAIN|LV_STATE_DEFAULT);

	//Write codes Main_label_57
	ui->Main_label_57 = lv_label_create(ui->Main_MainView_tab_1);
	lv_label_set_text(ui->Main_label_57, "目标高度差dH");
	lv_label_set_long_mode(ui->Main_label_57, LV_LABEL_LONG_WRAP);
	lv_obj_set_pos(ui->Main_label_57, 606, 360);
	lv_obj_set_size(ui->Main_label_57, 182, 34);

	//Write style for Main_label_57, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_border_width(ui->Main_label_57, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->Main_label_57, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_color(ui->Main_label_57, lv_color_hex(0xdcdcdc), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->Main_label_57, &lv_font_misans_20, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_opa(ui->Main_label_57, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_letter_space(ui->Main_label_57, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_line_space(ui->Main_label_57, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_align(ui->Main_label_57, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_opa(ui->Main_label_57, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_top(ui->Main_label_57, 8, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_right(ui->Main_label_57, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_bottom(ui->Main_label_57, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->Main_list_darts, 88, 57);
	...
	lv_obj_set_pos(ui->Main_label_35, 110, 9);
	...
	lv_obj_set_pos(ui->Main_cont_dart_param, 396, 57);
	lv_obj_set_size(ui->Main_cont_dart_param, 392, 418);
	...
	lv_obj_set_pos(ui->Main_label_40, 444, 9);
