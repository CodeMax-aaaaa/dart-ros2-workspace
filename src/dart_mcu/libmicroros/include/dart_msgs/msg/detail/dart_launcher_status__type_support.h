...
#ifndef DART_MSGS__MSG__DETAIL__DART_LAUNCHER_STATUS__TYPE_SUPPORT_H_
#define DART_MSGS__MSG__DETAIL__DART_LAUNCHER_STATUS__TYPE_SUPPORT_H_
...
#endif  // DART_MSGS__MSG__DETAIL__DART_LAUNCHER_STATUS__TYPE_SUPPORT_H_
